    ...
    return (
      <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
        ...
        <p className="text-amber-300/80 text-sm">
          AI Extension cannot be used on images with removed backgrounds. Use extension first, then
          remove background.
        </p>
      </div>
    );
    ...
    <div className="space-y-6">
      ...
      {selectedDirection && (
        <div className="bg-slate-700/30 rounded-lg p-3">
          ...
          <div className="text-xs text-white/70 space-y-1">
            <div>
              Current: {Math.round(currentImage.width * (currentImage.scaleX || 1))} ×{' '}
      ...
      <div className="bg-slate-700/30 rounded-lg p-3">
        <p className="text-xs text-white/70">
          <strong>How it works:</strong> Select one direction → Set amount → Apply extension. AI
          will intelligently fill the new area in that direction.
        </p>
      </div>
    </div>
  );
